...
struct Rectangle
{
    ...
    // We can use it to determine the minimums and maximums, ie float xMin = rec.position.x - rec.extents.x;
}
...
public class Detection : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Color color = CheckCollisionCircles(circle1.position, circle1.radius, circle2.position, circle2.radius) ? Color.green : Color.red;
        //circle1GO.GetComponent<SpriteRenderer>().color = color;
        //circle2GO.GetComponent<SpriteRenderer>().color = color;

        Color color = CheckCollisionCircleRect(circle1.position, circle1.radius, rect1.position, rect1.extents) ? Color.green : Color.red;
        circle1GO.GetComponent<SpriteRenderer>().color = color;
    ...
    // Version we made in class that uses objects (classes/structs)
